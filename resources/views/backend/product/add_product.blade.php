                            ...
                            <div class="tab-pane" id="settings">
                                <form id="myForm" method="post" action="{{ route('product.store') }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class=" form-group mb-3">
                                                <label for="book_group_id" class="form-label">Book Group</label>
                                                <select name="book_group_id" id="book_group_id" class="form-select">
                                                    <option value="" selected disabled>Select Group</option>
                                                    @foreach ($groups as $group)
                                                        <option value="{{ $group->id }}"
                                                            {{ isset($product) && $product->book_group_id == $group->id ? 'selected' : '' }}>
                                                            {{ $group->group_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
        ...
        $(document).ready(function() {
            $('#myForm').validate({
                ...
                messages: {
                    ...
                    book_group_id: {
                        required: 'Please Select Book Group',
                    },
                },
                errorElement: 'span',
