...
$(document).on('click', '.present', function() {
    $(this).parents('tr').find('.datetime').css({'pointer-events': 'none', 'background-color': '#dee2e6', 'color': '#495057'});
});

$(document).on('click', '.leave', function() {
    $(this).parents('tr').find('.datetime').css({'pointer-events': '', 'background-color': 'white', 'color': '#495057'});
});

$(document).on('click', '.absent', function() {
    $(this).parents('tr').find('.datetime').css({'pointer-events': 'none', 'background-color': '#dee2e6', 'color': '#dee2e6'});
});
</script>
...
$(document).on('click', '.present_all', function() {
    ...
    $('.datetime').css({'pointer-events': 'none', 'background-color': '#dee2e6', 'color': '#495057'});
});

$(document).on('click', '.leave_all', function() {
    $("input[value=Leave]").prop('checked', true);
    $('.datetime').css({'pointer-events': '', 'background-color': 'white', 'color': '#495057'});
});

$(document).on('click', '.absent_all', function() {
    $("input[value=Absent]").prop('checked', true);
    $('.datetime').css({'pointer-events': 'none', 'background-color': '#dee2e6', 'color': '#dee2e6'});
});
</script>
